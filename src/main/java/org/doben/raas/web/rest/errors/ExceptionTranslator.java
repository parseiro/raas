package org.doben.raas.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof org.doben.raas.service.EmailAlreadyUsedException ||
            ex instanceof org.doben.raas.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof org.doben.raas.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "org.doben.raas");
    }
}
